...
var _user$project$Link$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Change Page')
					])),
				_elm_lang$html$Html$text(
				_elm_lang$core$Basics$toString(model))
			]));
};
var _user$project$Link$initialUrl = _elm_lang$core$Native_Platform.incomingPort('initialUrl', _elm_lang$core$Json_Decode$string);
var _user$project$Link$Model = function (a) {
	return {page: a};
};
var _user$project$Link$Publication = function (a) {
	return {ctor: 'Publication', _0: a};
};
var _user$project$Link$Publications = {ctor: 'Publications'};
var _user$project$Link$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'NoMsg') {
			...
			var pageParser = _evancz$url_parser$UrlParser$oneOf(
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Link$Publication,
						A2(
							_evancz$url_parser$UrlParser_ops['</>'],
							_evancz$url_parser$UrlParser$s('publications'),
							_evancz$url_parser$UrlParser$int)),
						A2(
						_evancz$url_parser$UrlParser$format,
						_user$project$Link$Publications,
						_evancz$url_parser$UrlParser$s('publications'))
					]));
			var result = A3(
...
var _user$project$Link$Home = {ctor: 'Home'};
var _user$project$Link$initialModel = {page: _user$project$Link$Home};
var _user$project$Link$UrlUpdate = function (a) {
	return {ctor: 'UrlUpdate', _0: a};
};
var _user$project$Link$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Link$initialUrl(
				function (url) {
					return _user$project$Link$UrlUpdate(url);
				})
			]));
};
var _user$project$Link$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$Link$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
			view: _user$project$Link$view,
			update: _user$project$Link$update,
			subscriptions: _user$project$Link$subscriptions
		})
};
var _user$project$Link$NoMsg = {ctor: 'NoMsg'};

var Elm = {};
Elm['Link'] = Elm['Link'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Link'], 'Link', typeof _user$project$Link$main === 'undefined' ? null : _user$project$Link$main);
